...
public class GiantEntity extends Monster {
	public GiantEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(ZenithcraftModEntities.GIANT.get(), world);
	}
	...
	public static void init() {
		SpawnPlacements.register(ZenithcraftModEntities.GIANT.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
