...
import net.mcreator.zenithcraft.procedures.ElfMaleRightClickedOnEntityProcedure;
import net.mcreator.zenithcraft.init.ZenithcraftModItems;
import net.mcreator.zenithcraft.init.ZenithcraftModEntities;

public class ElfMaleEntity extends PathfinderMob {
	public ElfMaleEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(ZenithcraftModEntities.ELF_MALE.get(), world);
	}

	public ElfMaleEntity(EntityType<ElfMaleEntity> type, Level world) {
		super(type, world);
		setMaxUpStep(0.6f);
		xpReward = 8;
		setNoAi(false);
	...
	public InteractionResult mobInteract(Player sourceentity, InteractionHand hand) {
		...
		ElfMaleRightClickedOnEntityProcedure.execute(world, x, y, z, sourceentity);
		return retval;
	}
	...
	public static void init() {
		SpawnPlacements.register(ZenithcraftModEntities.ELF_MALE.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
