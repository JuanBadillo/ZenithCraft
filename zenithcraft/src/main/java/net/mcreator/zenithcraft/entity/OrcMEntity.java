...
import net.mcreator.zenithcraft.procedures.OrcMRightClickedOnEntityProcedure;
import net.mcreator.zenithcraft.init.ZenithcraftModItems;
import net.mcreator.zenithcraft.init.ZenithcraftModEntities;

public class OrcMEntity extends PathfinderMob {
	public OrcMEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(ZenithcraftModEntities.ORC_M.get(), world);
	}

	public OrcMEntity(EntityType<OrcMEntity> type, Level world) {
		super(type, world);
		setMaxUpStep(0.6f);
		xpReward = 7;
		setNoAi(false);
	...
	public InteractionResult mobInteract(Player sourceentity, InteractionHand hand) {
		...
		OrcMRightClickedOnEntityProcedure.execute(world, x, y, z, sourceentity);
		return retval;
	}
	...
	public static void init() {
		SpawnPlacements.register(ZenithcraftModEntities.ORC_M.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
